  ...
  return NextResponse.json(
    {
      ...
      signatur: order.vollmacht?.signatur
        ? {
            art: order.vollmacht.signatur.art,
            status: order.vollmacht.signatur.status,
            simuliert: order.vollmacht.signatur.simuliert,
            provider: order.vollmacht.signatur.provider,
          }
        : null,
