    ...
    <>
      ...
      <Container className="py-12">
        {code ? (
          ...
          <div className="rounded-[var(--radius-card)] border border-warn-700/25 bg-warn-100 p-6">
            <h2 className="text-base font-semibold text-warn-700">Zugriffscode fehlt</h2>
