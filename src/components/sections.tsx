    ...
    <Section tone="white" id="sofortzulassung">
      <div className="grid gap-12 lg:grid-cols-[minmax(0,1fr)_minmax(0,0.9fr)] lg:items-center">
        <div>
          ...
          <H2>Zulassen, ohne auf die Papiere zu warten</H2>
          <Lead>
            ...
            erhalten Sie den vorläufigen Zulassungsnachweis. Sobald die Schilder
            montiert sind, dürfen Sie damit bis zu 14 Tage fahren – Papiere und
        ...
        <Card className="bg-surface">
          ...
          <ol className="mt-5 space-y-4">
            {[
              ...
              ["Tag 1", "Schilder zugestellt, Vollmacht signiert, Antrag eingereicht"],
